...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "bcw.ipc", false, filepath.Join(os.TempDir(), "bcw.ipc")},
		{"data", "bcw.ipc", false, "data/bcw.ipc"},
		{"data", "./bcw.ipc", false, "./bcw.ipc"},
		{"data", "/bcw.ipc", false, "/bcw.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "bcw.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "bcw.ipc", true, `\\.\pipe\geth.ipc`},
