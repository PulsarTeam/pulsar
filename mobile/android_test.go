...
func TestAndroid(t *testing.T) {
	...
	workspace, err := ioutil.TempDir("", "pulsar-android-")
	if err != nil {
	...
	build.CopyFile(filepath.Join("libs", "pulsar.aar"), "pulsar.aar", os.ModePerm)
