...
// This init function sets defaults so cmd/swarm can run alongside bcw.
func init() {
...
func bzzd(ctx *cli.Context) error {
	...
	//bcw only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for bcw and swarm
