...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/giga.ipc",
			endpoint:    "/data/testnet/giga.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/giga.ipc",
			endpoint:    "/data/testnet/giga.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/giga.ipc",
			endpoint:    "/data/testnet/giga.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/giga.ipc",
			endpoint:    "/data/testnet/giga.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
