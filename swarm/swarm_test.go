...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/pulsar.ipc",
			endpoint:    "/data/testnet/pulsar.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/pulsar.ipc",
			endpoint:    "/data/testnet/pulsar.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/pulsar.ipc",
			endpoint:    "/data/testnet/pulsar.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/pulsar.ipc",
			endpoint:    "/data/testnet/pulsar.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
